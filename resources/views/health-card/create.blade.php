<x-app-layout>
    ...
    <div class="container my-4">
        <form method="POST" action="{{ route('health-card.store') }}" class="needs-validation" novalidate>
            ...
            <div class="card mb-4">
                <div class="card-header fw-bold">
                    <a class="d-flex justify-content-between text-decoration-none text-dark"
                       data-bs-toggle="collapse" href="#professionalInfo">
            ...
            {{-- Family History --}}
            <x-collapse-card id="familyHistory" title="Family History">
            ...
            <x-collapse-card id="pastMedical" title="Past Medical History">
            ...
            {{-- Last Taken --}}
            <x-collapse-card id="lastTaken" title="Last Taken">
            ...
            {{-- Social History --}}
<x-collapse-card id="socialHistory" title="Social History">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="food_preference" id="food_preference" class="form-control" maxlength="255">
           ...
           {{-- OB-GYN History --}}
<x-collapse-card id="obgyn" title="OB-GYN History (for female teachers)">
    <div class="row g-3 mb-3">
        <div class="col-md-4">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="mass_location" id="mass_location" class="form-control" maxlength="255">
            ...
            {{-- For Male Personnel --}}
            <x-collapse-card id="malePersonnel" title="For Male Personnel">
                <label for="digital_rectal_exam_done" class="form-label">Digital Rectal
                                                Exam Done?</label>
                                            <select id="digital_rectal_exam_done" name="digital_rectal_exam_done"
                                                class="form-select">
                                                <option value="">-- Select --</option>
                                                <option value="Y">Yes</option>
                                                <option value="N">No</option>
                                        ...
                                        <div class="col-md-4">
                                            <label for="digital_rectal_exam_date" class="form-label">Date (if
                                                Yes)</label>
                                            <input type="date" name="digital_rectal_exam_date"
                                                id="digital_rectal_exam_date" class="form-control">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="digital_rectal_exam_result" class="form-label">Result</label>
                                            <input type="text" name="digital_rectal_exam_result"
                                                id="digital_rectal_exam_result" class="form-control" maxlength="500">
                                        </div>
            </x-collapse-card>

            {{-- Present Health Status --}}
            <x-collapse-card id="presentHealth" title="Present Health Status">
                <label for="present_health_status_cough" class="form-label">Cough</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="present_health_status_dental_status" class="form-label">Dental
                                            Status</label>
                                        <input type="text" name="present_health_status_dental_status"
                                            id="present_health_status_dental_status" class="form-control"
                                            maxlength="500">
                                    </div>
                                    <div class="mb-3">
                                        <label for="present_health_status_present_medications_taken"
                                            class="form-label">Present Medications Taken</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="present_health_status_others"
                                            id="present_health_status_others" class="form-control" maxlength="500">
                                    </div>
                                </div>
                            </div>
