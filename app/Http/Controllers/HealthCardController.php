...
{
    $healthInformation = $request->validate([
        ...
        'family_history_hypertension_relationship' => 'nullable|string|max:255|required_if:family_history_hypertension,Y',

        'family_history_cardiovascular_disease' => 'nullable|string|in:Y,N',
        'family_history_cardiovascular_disease_relationship' => 'nullable|string|max:255|required_if:family_history_heart_disease,Y',

        'family_history_diabetes_mellitus' => 'nullable|string|in:Y,N',
        'family_history_diabetes_mellitus_relationship' => 'nullable|string|max:255|required_if:family_history_diabetes,Y',

        'family_history_kidney_disease' => 'nullable|string|in:Y,N',
        'family_history_kidney_disease_relationship' => 'nullable|string|max:255|required,_if:family_history_kidney_disease,Y',

        'family_history_cancer' => 'nullable|string|in:Y,N',
        'family_history_cancer_relationship' => 'nullable|string|max:255|required_if:family_history_cancer,Y',

        'family_history_asthma' => 'nullable|string|in:Y,N',
        'family_history_asthma_relationship' => 'nullable|string|max:255|required_if:family_history_asthma,Y',

        'family_history_allergy' => 'nullable|string|in:Y,N',
        'family_history_allergy_relationship' => 'nullable|string|max:255|required_if:family_history_allergy,Y',
        ...
        'had_been_hospitalized' => 'required|boolean',
        ...
        // OB-GYN History (for female teachers)
